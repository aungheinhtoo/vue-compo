...
const getVariantColorSpecifics = (
    color: ButtonColor,
...
<template>
    <button
        class="box-content flex flex-row justify-center gap-2 rounded-lg font-body text-base font-semibold hover:drop-shadow-custom"
